...
SECRET_KEY = 'django-insecure-fh&udc&2@gkm@(t1srcqlky!(1aab45k0e&ad2%rd-b)&+-8kd'
...
DATABASES = {
    'default': {
		...
		'PORT': env('DB_PORT'),
		'OPTIONS': {
			'options': '-c search_path=auth,core,public'
        }
    }
}
...
AUTHENTICATION_BACKENDS = [
	'people.auth_backend.HardcodedAuthBackend',
